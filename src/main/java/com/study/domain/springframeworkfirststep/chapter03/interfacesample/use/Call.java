...
import com.study.domain.springframeworkfirststep.chapter03.interfacesample.used.SubCalculator;
...
public class Call {
    public static void main(String[] args) {
         ...
         */
        Calculator calculator = new SubCalculator(); // 인터페이스 구현클래스를 인스턴스화
